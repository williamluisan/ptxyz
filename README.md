...
Dengan menerapkan arsitektur *microservice* memungkinkan untuk PT XYZ melakukan *scalability* *resources* secara terpisah untuk masing-masing proses bisnis dan dalam aspek *adaptability* pengembangan dapat dilakukan dengan memisahkan *microservice* untuk proses bisnis customer dan product atau dengan menambahkan sebuah *microservice* yang baru untuk proses bisnis yang baru.
